...
### Nam: some changes might need to be carried out
...
### github auth parameters
OAUTH_GITHUB_CLIENT_ID = 'Iv1.4c1e0de7669e7d92'
OAUTH_GITHUB_CLIENT_SECRET = '167f82d7a7aa763c513c4423e72dfb9c384a973b'
...
### for more collaborative use of the knowledge posts, reduce INDEXING_INTERVAL
